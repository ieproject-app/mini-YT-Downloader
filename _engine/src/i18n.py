...
_STRINGS = {
    ...
    "en": {
        ...
        "key.bridge.paste_direct_hint": "[dim]…or just paste your API key right here[/dim]",
        ...
        "update.prompt": "Install this update now? (type y = yes, n = not now)",
    ...
    "id": {
        ...
        "key.bridge.paste_direct_hint": "[dim]…atau langsung paste API key Anda di sini[/dim]",
        ...
        "update.prompt": "Pasang update ini sekarang? (ketik y = ya, n = nanti)",
